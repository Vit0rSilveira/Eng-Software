        ...
        <>
            ...
            <div class="container">
                <div class="row mt-5 mb-5">
                    ...
                    <div class=" border border-dark rounded offset-1 col-4 bg-light p-5 mb-5">Coluna 2</div>

                    <div class=" border border-dark rounded offset-1 col-4 bg-light p-5 ">Coluna 1</div>
                    <div class=" border border-dark rounded offset-1 col-4 bg-light p-5">Coluna 2</div>
                </div>
            </div>
